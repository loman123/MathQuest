...
fun AdditionScreen() {
    Column(
        ...
        // Wprowadzenie
        Text(
            text = "Dodawanie to takie działanie, w którym łączysz rzeczy razem, żeby zobaczyć, ile jest ich w sumie. To jak układanie klocków w jednym stosie albo liczenie cukierków w misce.\n\nPrzykład:\nWyobraź sobie, że masz 2 jabłka, a ktoś daje Ci jeszcze 3 jabłka. Teraz liczysz, ile masz razem jabłek:\n\n2 jabłka + 3 jabłka = 5 jabłek.\nDodawanie to po prostu liczenie wszystkiego razem! \n\nPrzykłady pokazują się randomowo",
            fontSize = 16.sp,
            color = Color.White, // Biały kolor tekstu
        ...
        // Zadania dodawania
        repeat(15) {
            val number1 = (1..50).random()
            val number2 = (1..50).random()
            Spacer(modifier = Modifier.height(8.dp))
            AdditionExercise(number1, number2)
        }
    }
}
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AdditionExercise(number1: Int, number2: Int) {
